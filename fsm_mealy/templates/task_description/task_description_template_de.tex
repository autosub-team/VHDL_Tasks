...
\item F\"ur Eing\"ange, f\"ur die kein \"Ubergang im Diagramm definiert ist, soll folgendes Verhalten implementiert werden: Zustand soll sich nicht \"andern, OUTPUT = "00".
\end{itemize}
\vspace{0.5cm}
